...
const degreesCelcius = Number.parseFloat(prompt("Введите температуру в градусах Цельсия: "));
alert(`Цельсий: ${degreesCelcius}, Фаренгейт: ${Math.round(9 / 5 * degreesCelcius + 32)}`);
